...
public class NotifyContestedApplicationIssuedTest {
    private static final String CONTESTED_APPLICATION_ISSUED_API_URI = "/notify/contested/application-issued";
    ...
    @Test
    public void givenCaseData_whenNotifyContestedApplicationIssued_ThenShouldSendNotificationSuccessfully() throws Exception {
        notificationRequest.setName(TEST_SOLICITOR_NAME);

        webClient.perform(post(CONTESTED_APPLICATION_ISSUED_API_URI)
    ...
    @Test
    public void givenCaseData_whenNotifyContestedApplicationIssued_ThenShouldThrowNotificationException() throws Exception {
